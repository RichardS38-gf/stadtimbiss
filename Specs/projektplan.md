...
**Vercel-URL:** (wird nach Phase 1 eingetragen)
**GitHub:** (wird nach Phase 1 eingetragen)
...
|-------|--------|-------|--------|
| 1 | GitHub-Repo, Vercel, Ordnerstruktur, CSS-Grunddateien | phase-1-grundlage.md | offen |
